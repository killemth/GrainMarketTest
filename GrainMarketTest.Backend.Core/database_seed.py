...
INVENTORY = [
    {
        ...
        "OwnerEntityId": Entity.query.filter_by(EntityName = "Super Evils").one().EntityId,
        "Quantity": 500
    },
    {
        "CommodityId": Commodity.query.filter_by(CommodityName = "Corn").one().CommodityId,
        "OwnerEntityId": Entity.query.filter_by(EntityName = "The Good Guyz").one().EntityId,
        "Quantity": 150
    },
    {
        "CommodityId": Commodity.query.filter_by(CommodityName = "Corn").one().CommodityId,
        "OwnerEntityId": Entity.query.filter_by(EntityName = "Combine McHarvesterFace").one().EntityId,
        "Quantity": 725
    }
]
...
### databaseContext.session.add(ApiKey(ApiKeyId = 1, ApiKey = "2da30c1c-50d9-4ea6-936b-b23cbf4405fb", IsLocked = False))
